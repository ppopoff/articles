...
Эта серия статей, а если быть честным, набор заметок, посвящены ошибкам, которые
совершают новички, ступая на тропу Scala. И не только  джуниоры, но и умудренные
опытом программисты, с сединами в бороде, решившиые испробовать Scala. Для

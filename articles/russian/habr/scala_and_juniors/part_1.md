...
в первой части мы поговорим об идиомах функционального программирования в Scala,
а во-второй — обсудим объектно-ориентированные идиомы.
...
создавать не только [синонимы типов](https://wiki.haskell.org/Type_synonym), но
и [алгебраические типы данных](https://en.wikipedia.org/wiki/Algebraic_data_type):

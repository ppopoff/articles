...
кроме того, они здоворо улучшают читаемость кода, в котором замешаны
...
используется в языке многокрантно и в различных контекстах.
[Здесь](https://www.slideshare.net/normation/scala-dreaded) это хорошо
проиллюстрированно. В большинстве случаев без нижнего подчеркивания обойтись
...
При сопоставлении с образцом, они также способны попорить жизнь.

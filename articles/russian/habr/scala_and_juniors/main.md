...
И не только новички в нашем привычном понимании aka *джуниоры*, но и умудренные
опытом программисты, с сединой в бороде. Для многих, особенно имевших в своем
бэкграунде императивные языки, такие как C/C++/Java, многие идиомы Scala
являются непонятными, более того, неочевидными. Особенно если писать на этих
языках всю молодость, и часть зрелости. И это нормально.

> Беженцы с Ruby усваивают Scala быстрее остальных. Интересно, почему? :)

В свое время я попал
в очень интересную ситуацию -- мне тогда еще 23х летнему разработчику пришлось
объяснять скалические идиомы старшим коллегам, а с джуниорами я сталкиваюсь
регулярно. В компании где я работаю существует внутренняя система координации
образовательной деятельности: с курсами и проверяющими. Я как раз занимаюсь
проверкой и поддержкой курсов по Scala. Эта статья является коллекцией ошибок,
и недопонятых идиом, совершаемых *молодыми* специалистами. Так же я добавлю
сюда ряд личных рекомендаций (с которыми вы конечно можете не согласиться). Но
я все-равно их добалвю. И да, пока у вас не родится первый внук -- вы молодой
программист. А когда родится первый внук? Тогда вы будете зрелым разработчиком.


> Изначально, статья должна была писаться на английском и называться так:
> "Scala for juniors and junior-seniors", но пишется она на русском. И я
> на данный момент я понятия не имею как это перевести. Статья не подразумевает
> собой чистых джуниоров. У них много проблем без этого.



# Типичные ошибки

## Типовыые ошибки и ООП

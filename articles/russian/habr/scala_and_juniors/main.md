...
ступая на тропу Scala. И не только новички в нашем привычном понимании aka
*джуниоры*, но и умудренные опытом программисты, с сединой в бороде. Для
...
старшим коллегам: я, можно сказать, начинал свою карьеру Scala-разработчиком.
Сейчас, я общаюсь с разработчиками разного уровня, решившими освоить Scala.

В компании где я работаю, существует внутренняя система координации
образовательной деятельности.В данный момент я, вместе с другими проверяющими,
занимаюсь проверкой и поддержкой курсов по Scala.
...
сделает ваш код более читаемым, ибо согласитесь, что `Map[Username, Key]`
...
Псевдонимы типов, в первую очередь позволяют именовать сложные структуры,
состоящие из различного типа вложенных коллекций.

...
## Длина выражений
Я называю длинные выражения поездами в виду того, что в мире Java поезда имеют
символическое значение. В Scala практически все является выражением, и даже
если что-то возвращает `Unit` вы всегда можете получить на выходе ваш `()`.
После длительного программирования на языках где превалируют утверждения
(statements), у многих из нас (я не являюсь исключением), превалирует желание
запихнуть все в одно выражение, сделав длинный-длинный паровозик. Вот вам
...
Сейчас, вагончики активно сцепляются начинающими пользователями Apache Spark.
Пожалуйста, разделяйте выражения. Читать тяжело.

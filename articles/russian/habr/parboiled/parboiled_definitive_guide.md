...
В качестве примера будет использоваться формат BKV, который был придуман специально для этого туториала. Он вдохновлялся
форматом [HOCON](https://github.com/typesafehub/config/blob/master/HOCON.md). И, собственно является его подмножеством.

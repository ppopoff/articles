...
# Миграция
Данный раздел посвящен миграции. Отмечу что для меня она приходила весьма болезненно.
...
Mock-объекты, и другие ухищрения для этой рутинной, но очень полезной работы. У нас была целая инфраструктура парсеров.
И поверье, первое что я делал при поиске ошибок - садился и писал тесты. Много тестов. Которые выглядели как специкации.

...
### "Функция действия" 
Ддя соверщения операций над захваченными объектами существует функция ~> Он снимает значения cо стека значений и
позволяет вам проделать с этими операциями некие действия, а потом, возможно положить в стек. Это уже зависит от вашего
желания. Для того чтобы действие осуществилось, функция Capture должна является обязательной и про нее не стоит забывать
(Привет пользователям Parboiled1). 

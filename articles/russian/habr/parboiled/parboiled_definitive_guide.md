...
и Planck (OCaml) уже успели хорошо себя зарекомендовать в своих экосистемах. Их удобство и востребованность в своё время
...
Combinators. Мы подробно рассмотрим работу с текущей версией библиотеки — Parboiled2, а также уделим внимание
Parboiled1, так как большая часть существующего кода всё ещё использует именно её. Мы затронем следующие вопросы:
...
(Кат: Читать про ска́лу и парсеры →)
...
На данный момент существует несколько версий данной библиотеки:
  ...
  - Parboiled for Java — самая первая версия библиотеки. Написанна Маттиасом Доеницем (Matthias Doeniz)
...
------------------------------------------------------------------------------------------------------------------------
# Про Parboiled
# Часть 2: Как работать с библиотекой

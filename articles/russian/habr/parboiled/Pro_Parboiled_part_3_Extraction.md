...
В этой статье мы напишем парсер для уже описанного нами ранее формата конфигурационных файлов. Мы также реализуем
...
TODO: на калькулятор не рабочая ссылка не знаю что делать с ней
...
относительно комфортной. В следующей статье я расскажу об использовании Parboiled в продакшне, его недостатках и о том,
как с этими недостатками жить.

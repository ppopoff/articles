...
Ключ и Имя блока представляют собой идентификатор похожий на те, что вы можете встретить в различных языках
программирования. Идентификатор может должен начинаться либо с буквы английского алфавита (регистр не имеет значения),
либо с символа нижнего подчеркивания. В середине может содержать цифры, буквы английского алфавита (строчные и
...
Для описания значения воспользуемся уже имеющимся правилом (для этого нам всего-то нужно подмешать написанный нами ранее
трейт):

...
# Best practices
В этом разделе я расскажу о прописных истинах работающих для любого комбинатора парсеров , а так же нюансах,
...
использует `capture`. Усугублять ситуацию может неявный захват. Указание типа правила так же помогает при поддержке.
